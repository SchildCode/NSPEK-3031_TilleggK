# NSPEK-3031_TilleggK
- Simulation of hourly performance of heat-pumps or chillers by means of bilinear interpolation of capacity and COP in accordance with International standards ISO 13612-2 <sup>[[2]](#2)</sup>, EN 14825 <sup>[[4]](#4)</sup>, and Appendix K of Norwegian Technical Specification SN NSPEK 3031:2020 <sup>[[1]](#1)</sup>.
- The workbook also calculates part-load COP using a relation between Part-Load Factor (PLF) vs Part-Load Ratio (PLR). This is done in a flexible way that can handle all kinds of heat pump (both single-speed and variable-speed compressors for air/air, air/water, water/air or water/water heat pumps). This approach is documented in two papers <sup>[[6]](#6)[[7]](#7)</sup>, and is an improvement upon EN 13612-2, EN 14825, but still compliant by adjusting the 3 coefficients.
